...
public class SortDemo extends Application {  
  ...
  public void start(Stage primaryStage) {     
    ...
    Button btStep = new Button("Selection");
    Button btInsertion = new Button("Insertion");
    Button btBubble = new Button("Bubble");
    Button btReset = new Button("Reset");
    
    HBox hBox = new HBox(5);
    hBox.getChildren().addAll(btStep, btInsertion,  btReset);
    ...
    primaryStage.setTitle("Sort Demo"); // Set the stage title
    ...
    btInsertion.setOnAction(e -> {    
        if (control.insertion()){ 
        	if (control.getCurrentIndex() < ARRAY_SIZE - 1)
        		pane.setColoredBarIndex(control.getCurrentIndex() + 1);
        	else 
        		pane.setColoredBarIndex(control.getCurrentIndex());
        }
        else
...
class StepControl {
    ...
    //ArrayList<Integer>[] alist = new ArrayList[3];
    ...
    public boolean insertion() {      
        ...
        // Insert into sorted sublist list [0..i-1]
