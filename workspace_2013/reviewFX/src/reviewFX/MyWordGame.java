...
//	          processAGuessedLetter(e.getText().charAt(0) + "");
	    ...
	    void paint2(){
	    	 this.getChildren().add(new Text(Y+100, Y,  "The word is: " 
	    			 + letters.toString()));
	    }
	    ...
	    public void paint(){
	    	...
	    	circle.setCenterY(Y);
		   	...
		   	circle.setStroke(Color.rgb(10 + 30*missedLetterSet.size(), 250 - 30*missedLetterSet.size(), 100));
		   	circle.setFill(Color.rgb(10 + 30*missedLetterSet.size(), 10 + 30*missedLetterSet.size(), 130));
