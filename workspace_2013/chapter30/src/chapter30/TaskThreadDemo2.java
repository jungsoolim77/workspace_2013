...
public class TaskThreadDemo2 extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    Thread printA = new Thread(new PrintChar('A', 50));
    Thread printB = new Thread(new PrintChar('B', 50));
    Thread  print100 = new Thread(new PrintNum(20));
    ...
    primaryStage.setTitle("Task Thread Demo"); // Set the stage title
