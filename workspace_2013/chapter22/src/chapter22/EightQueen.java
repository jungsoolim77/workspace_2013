...
public class EightQueen extends Application {
  ...
  private Integer[] queens = {0, -1, -1, -1, -1, -1, -1, -1}; 
...
//    for (int i = 0; i < list.size(); i++) {
    ...
    primaryStage.setTitle("Eight Queens"); // Set the stage title
  ...
  public void printASolution(Integer[] queens) {
  ...
  private BorderPane getChessBoardWithLabel(String label, Integer[] queens) { 
  ...
  private GridPane getChessBoard(Integer[] queens) {
    // Display chess board
...
//    	labels[i][queens[i]].setText("Queen");
//    	System.out.println("row i " + i + " Col queen i " + queens[i]);
