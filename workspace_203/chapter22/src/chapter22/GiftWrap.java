...
public class GiftWrap extends Application {  
  double radius = 2;
  ...
  public void start(Stage primaryStage) {     
    ...
    primaryStage.setTitle("Non Crossing Polygon"); // Set the stage title
  ...
  class View extends Pane {
    ...
    protected void drawNewPolygon() {     
      ...
      if (listOfCircle.size() >= 3) {
        ...
        ArrayList<MyPoint> listOfPoints = GiftWrap.getPolygon(points);
